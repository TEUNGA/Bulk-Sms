...
@section('title')
{{__('Bulk-Sms')}} | {{__('Admin| VIEW GROUP CONTACTS')}}
@endsection

@section('page-name')
{{__('Admin | VIEW GROUP CONTACTS')}}
@endsection
      ...
      <div class="container-fluid">
          ...
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">{{$contact_group->group_name}} Group Contacts </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="demotable" class="table table-bordered table-hover dataTable table">
                    ...
                    <tbody>
                        ...
                        <td>{{$contact_group->users_phone}}  </td>
                         <td>

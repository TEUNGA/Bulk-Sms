             ...
             <div class="card-header">
              ...
              <form role="form" method="post" action="{{ route('admin.store_sms')}}">
                ...
                <div class="card-body">
                        ...
                        <select id="multiselect" name="contact[]" class="select2" style="width:100% !important" multiple="multiple" data-live-search="true">
                            @foreach($contacts as $contact)
                           <option value="{{$contact->id}}" name="contact_id"> {{$contact->users_name}} </option>
                            @endforeach 
                            </select>
                        </div>
                  <div class="form-group">
